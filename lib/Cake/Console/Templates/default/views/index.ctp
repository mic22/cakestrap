 ...
 */
?>
<div class="col-md-9 <?php echo $pluralVar; ?> index">
	...
	<table class="table table-striped table-condensed">
		...
		echo "\t<tr>\n";
			...
			echo "\t\t\t<?php echo \$this->Html->link(__('View'), array('action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('class' => 'btn btn-xs btn-default')); ?>\n";
			echo "\t\t\t<?php echo \$this->Html->link(__('Edit'), array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('class' => 'btn btn-xs btn-default')); ?>\n";
